...
define("SMTP_UNAME", "manh.nguyen22@student.passerellesnumeriques.org"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "zygecfdvzvqvtagz"); //Password for SMTP authentication
