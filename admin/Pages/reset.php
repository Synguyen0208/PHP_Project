                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="post" acction="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputPassword" name="confirm-password" type="password" placeholder="Enter password" />
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="login.php">Go to login page!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
