...
define("SMTP_UNAME", "khua.ho22@student.passerellesnumeriques.org"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "bpfrrrexindabffm"); //Password for SMTP authentication
